...
public class DailyBankMainFrame extends Application {
	...
	/**
	 * Passe à la fenêtre de gestion des clients
	 */
	...
	{
		EmployeeManagement cm = new EmployeeManagement(this.primaryStage, this.dbs);
		
		cm.doEmployeeManagementDialog();
	}
}
